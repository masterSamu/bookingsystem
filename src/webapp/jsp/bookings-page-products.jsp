    ...
    <div class="container-fluid main-container">
        <div class="container-fluid header-container">
            <div class="col-sm-6 col-left">
                <h1 class="page-heade">Varaukset tuotteelle</h1>
                <p><b>Tuotekoodi:</b> <a href="/tuotesivu?productid=${product.product_id }">${product.productcode }</a> <b>Tuote:</b> ${product.name } <img src="${product.image}" width="100px" height="100px"></p>
            </div>
            ...
            <div class="table-container">
                <table class="table" id="table">
                    <tr>
                        ...
                        <th>Puhelin</th>
                        <th>Lisätiedot</th>
                        <th class="tableHeader" onclick="sortTable(6)">Määrä</th>
                    ...
                    <tr class="data">
                        ...
                        <td class="td-bookingpage">
                            <p class="tuote-info">${bookingInfo.customer.firstname }</p>
                        </td>
                        <td class="td-bookingpage">
                            <p class="tuote-info">${bookingInfo.customer.lastname }</p>
                        </td>
                        <td class="td-bookingpage">
                            <p class="tuote-info">${bookingInfo.customer.email }</p>
                        </td>
                        <td>
                            <p class="tuote-info">${bookingInfo.customer.phone }</p>
                        </td>
                        <td>
                        ...
                        <td class="td-icon">
                        	<a href="/editbooking-page?id=${bookingInfo.booking.booking_id}&p2=${bookingInfo.productWithSuppliers.product.product_id}&p3=${bookingInfo.customer.customer_id}">
