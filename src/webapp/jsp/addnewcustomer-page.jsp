    ...
    <div class="container-fluid main-container">
        <div class="container-fluid header-container">
            <div class="col col-left">
                <h1 class="page-heade">Lisää uusi asiakas</h1>
            </div>
        </div>
        <div class="container-fuild tuote-container">
            ...
            <div class="container-fluid inner-container">
                ...
                <form class="tuotetieto-form" action="/addnewcustomer" method="POST">
                    <div class="row">
                        <div class="col">
                            <label for="firstname" class="label-input">Etunimi</label>
                            <input type="text" class="form-control uusituote-input" name="firstname" id="firstname" maxlength="50">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="lastname" class="label-input">Sukunimi</label>
                            <input type="text" class="form-control uusituote-input" name="lastname" id="lastname" maxlength="50">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="email" class="label-input">Sähköposti</label>
                            <input type="text" class=" form-control uusituote-input" name="email" id="email" maxlength="255" required>
                            <div class="warning" id="emailWarningMessage"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="phone" class="label-input">Puhelin</label>
                            <input type="tel" class=" form-control uusituote-input" name="phone" id="phone" maxlength="20">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="additionalInformation" class="label-input">Lisätiedot</label>
                            <textarea class="form-control uusituote-input" name="additionalInformation" id="additionalInformation" maxlength=255></textarea>
                        </div>
                    </div>
        ...
        <script src="/js/validateCustomerInformation.js"></script>
</body>
</html>