    ...
    <div class="container-fluid main-container">
        <div class="container-fluid header-container">
            ...
            <div class="col-sm-6 col-right">
                <a href="/lisaatoimittajasivu"><button class="btn upper-btn">Lisää uusi toimittaja</button></a>
            </div>
        </div>
	        	...
	        	<div class="col-sm-12">
	        		...
	        		<div class="tooltip-info">
		            	...
		            	<div class="tooltiptext">
		            		...
		            		<h3>Muokkaaminen</h3>
		            		<p>Toimittajan nimeä klikkaamalla auvautuu toimittaja kohtainen sivu, josta voi muokata tietoja.</p>
		            		<h3>Varaukset</h3>
		            		<p><a href="#">Näytä varaukset</a> näköistä linkkiä painamalla siiryt sivulle, mistä näet kyseisen toimittajan tuotteiden varaukset.</p>
		            		<h3>Poista</h3>
		            		<p>
                                ...
                                Roskakorin näköistä ikonia klikkaamalla asiakas poistuu pysyvästi. Samalla toimittaja poistuu kaikkien tuotteiden tiedoista mihin se on valittu.
		            		</p>
		            	</div>
		            </div>
        	</div>
            <div class="table-container">
                <table class="table" id="table">
                    ...
                    <tr class="data">
                        ...
                        <td>
                        	<a href="/showbookingsforsupplier?id=${suppliers.supplier_id}">Näytä varaukset</a>
                        <td>
