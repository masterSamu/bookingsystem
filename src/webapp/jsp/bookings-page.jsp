    ...
    <div class="container-fluid main-container">
        <div class="container-fluid header-container">
            <div class="col-sm-6 col-left">
                <h1 class="page-heade">Varaukset</h1>
            </div>
	        	...
	        	<div class="col-sm-12">
		            ...
		            <div class="tooltip-info">
		            	...
		            	<div class="tooltiptext">
		            		...
		            		<h3>Haku</h3>
		            		<p>Voit etsiä millä tahansa taulukon hakusanalla ja taulukossa näkyy vain haetut tiedot. Voit etsiä myös viivakoodilla tai toimittajan nimellä.</p>
		            		<h3>Suodatus</h3>
            ...
            <div class="table-container">
                <table class="table" id="table">
                    <tr>
                        ...
                        <th class="tableHeader" onclick="sortTable(4)">Tuotekoodi</th>
                        <th class="tableHeader" onclick="sortTable(5)">Tuotteen nimi</th>
                        <th>Tuotekuva</th>
                        <th>Lisätiedot</th>
                        <th class="tableHeader" onclick="sortTable(8)">Määrä</th>
                    ...
                    <c:forEach var="booking" items="${requestScope.bookings}" varStatus="trindex">
                    <tr class="data" id="tr-index-${trindex.index }">
                        <td class="th-icon">
                            <input type="checkbox" name="informed" id="${booking.booking_id}" value="${booking.informed }" <c:if test="${booking.informed == true }"><c:out value="checked"/></c:if>>
                        </td>
                        ...
                        <td>
                      		<p class="tuote-info">${booking.additionalInformation}</p>
                        </td>
                        <td class="tuote-info-amount">
                        	<p class="tuote-info">${booking.amount }</p>
                        </td>
                        <td class="td-icon">
                        	<a href="/editbooking-page?id=${booking.booking_id}&p2=${booking.product_id}&p3=${booking.customer_id}">
                        ...
                        <td class="td-icon">
	                       	<svg id="${booking.booking_id}" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-bag-check bag-icon" viewBox="0 0 16 16">
							  <path fill-rule="evenodd" d="M10.854 8.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L7.5 10.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
							  <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z"/>
							</svg>
                        </td>
                        ...
                        <td class="hide">
                            <p class="tuote-info">
	                            <c:forEach var="ps" items="${requestScope.productsuppliers }">
	                           		<c:forEach var="suppliers" items="${requestScope.suppliers }">
		                            	<c:if test="${ps.product_id == booking.product_id }">
		                            		<c:if test="${ps.supplier_id == suppliers.supplier_id }">
		                            			<c:out value="${suppliers.name }"/>
		                            		</c:if>
	                            		</c:if>
		                            </c:forEach>
	                            </c:forEach>
